...
;(function __FuckShortenedUrl() {
  ...
  //   _pendingRequest: [],
  //   request(url, options) {
  //     if (httpClient._currentWorkers >= httpClient._maxWorkers) {
  //       httpClient._pendingRequest.push([url, options])
  //       return
  //     }
  //     httpClient._currentWorkers += 1

  //     var userOnloadFn = options.onload
  ...
  //         if (userOnloadFn) {
  //           userOnloadFn(response)
  //         }

  //         if (httpClient._pendingRequest.length > 0) {
  //           var params = httpClient._pendingRequest.shift()
  //           httpClient.request(params[0], params[1])
  //         }
  //       }
  //     })

  //     GM.xmlHttpRequest(_options)
  //   }
  // }
  //
  var utils = {
    ...
    // getRedirectUrlAndSet: function(url, $link) {
